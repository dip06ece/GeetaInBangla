...
import com.dip.geetainbangla.databinding.FragmentChapter6Binding


class Chapter6Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChapter6Binding.inflate(inflater, container, false)
        return binding.root
    }
