...
import com.dip.geetainbangla.databinding.FragmentChapter3Binding


class Chapter3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChapter3Binding.inflate(inflater, container, false)
        return binding.root
    }
