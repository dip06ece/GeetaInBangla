...
import com.dip.geetainbangla.databinding.FragmentChapter12Binding


class Chapter12Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChapter12Binding.inflate(inflater, container, false)
        return binding.root
    }
