...
import com.dip.geetainbangla.databinding.FragmentChapter5Binding


class Chapter5Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChapter5Binding.inflate(inflater, container, false)
        return binding.root
    }
