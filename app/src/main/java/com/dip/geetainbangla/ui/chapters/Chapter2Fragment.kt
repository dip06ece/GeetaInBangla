...
import com.dip.geetainbangla.databinding.FragmentChapter2Binding
...
class Chapter2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChapter2Binding.inflate(inflater, container, false)
        return binding.root
    }
