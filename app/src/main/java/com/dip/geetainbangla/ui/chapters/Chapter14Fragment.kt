...
import com.dip.geetainbangla.databinding.FragmentChapter14Binding


class Chapter14Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChapter14Binding.inflate(inflater, container, false)
        return binding.root
    }
