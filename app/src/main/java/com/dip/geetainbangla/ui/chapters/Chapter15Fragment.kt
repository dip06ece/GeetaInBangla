...
import com.dip.geetainbangla.databinding.FragmentChapter15Binding


class Chapter15Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChapter15Binding.inflate(inflater, container, false)
        return binding.root
    }
