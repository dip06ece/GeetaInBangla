...
import com.dip.geetainbangla.databinding.FragmentChapter4Binding


class Chapter4Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChapter4Binding.inflate(inflater, container, false)
        return binding.root
    }
