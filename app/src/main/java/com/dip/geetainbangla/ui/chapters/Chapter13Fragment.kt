...
import com.dip.geetainbangla.databinding.FragmentChapter13Binding


class Chapter13Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChapter13Binding.inflate(inflater, container, false)
        return binding.root
    }
